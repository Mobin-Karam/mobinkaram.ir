      ...
      <div className="grid gap-3 md:grid-cols-2">
        {filtered.map((post) => (
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] p-4 shadow-[var(--glow)] transition hover:-translate-y-0.5 hover:shadow-lg"
          >
            {post.cover ? (
